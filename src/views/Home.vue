    ...
    <div class="home grid gap-0 grid-cols-1 md:grid-cols-2 bg-blackl w-full md:w-screen h-full md:h-screen">
        <div class="welcome text-white">
            <div class="container p-24 flex flex-col">
                <p class="welcome-user">Hello, <span class="username">Empre Emerald</span></p>
                ...
                <div class="flex flex-row">
                    <div v-for="(card, index) in cards" :key="index" :tabindex="index" class="card-option">
                        <div
                            class="card flex justify-center items-center rounded-2xl mr-8"
        ...
        <div class="w-full h-full p-4 md:overflow-hidden">
            <div class="bg-gray1 w-full h-full rounded-2xl px-14 py-12">
                <div class="w-full h-full rounded-2xl font-blackl">
                    ...
                    <div class="result-window w-full h-2/3 rounded-xl mt-6 overflow-y-auto">
                        <users v-if="window_type === 'Users'" />
